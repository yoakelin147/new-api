...
import { getUserQuotaDataByTokens } from '@/features/dashboard/api'
import {
...
export function KeyCharts() {
  ...
  const { data: tokenData, isLoading } = useQuery({
    ...
    queryFn: () => getUserQuotaDataByTokens(timeRange),
            ...
            >
              ...
              <div className='h-[300px] p-1.5 sm:h-96 sm:p-2'>
                {isLoading ? (
                  ...
                  spec && (
                    <VChart
                      key={`token-${chart.value}-${topTokenLimit}-${resolvedTheme}-${customization.preset}`}
                      spec={{
                        ...spec,
