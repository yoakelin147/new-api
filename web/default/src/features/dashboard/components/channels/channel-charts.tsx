...
import { getUserQuotaDataByChannels } from '@/features/dashboard/api'
import {
...
import type { ProcessedChannelChartData } from '@/features/dashboard/types'
...
const CHANNEL_CHARTS: {
  value: string
  labelKey: string
  specKey: keyof ProcessedChannelChartData
}[] = [
  {
    value: 'rank',
  ...
  {
    value: 'trend',
    labelKey: 'Channel Consumption Trend',
    specKey: 'spec_channel_trend',
  },
]
...
export function ChannelCharts() {
  ...
  const { data: channelData, isLoading } = useQuery({
    ...
    queryFn: () => getUserQuotaDataByChannels(timeRange),
  ...
  return (
    <div className='flex flex-col gap-3'>
      <div className='flex items-center gap-1.5 overflow-x-auto pb-1 sm:gap-2'>
        ...
        <Tabs
          value={String(topChannelLimit)}
          onValueChange={(value) => setTopChannelLimit(Number(value))}
          className='shrink-0'
        >
          <TabsList>
          ...
          return (
            ...
            >
              <div className='flex w-full items-center gap-2 border-b px-3 py-2 sm:px-5 sm:py-3'>
                <RadioTower className='text-muted-foreground/60 size-4' />
              ...
              <div className='h-[300px] p-1.5 sm:h-96 sm:p-2'>
                {isLoading ? (
                  ...
                  spec && (
                    <VChart
                      key={`channel-${chart.value}-${topChannelLimit}-${resolvedTheme}-${customization.preset}`}
                      spec={{
                        ...spec,
